...
from vllm.attention.ops.triton_sparse_mla import triton_fp8_mqa_logits, triton_fp8_paged_mqa_logits

from vllm.model_executor.models.deepseek_v2 import _pytorch_mqa_logits
...
def test_triton_fp8_mqa_logits(seq_len_qkv, disable_cp, device):
    torch.manual_seed(0)
    random.seed(0)
...
@pytest.mark.parametrize("device", DEVICES)
def test_triton_fp8_paged_mqa_logits(bs_nextn, device):
    torch.manual_seed(0)
    random.seed(0)
