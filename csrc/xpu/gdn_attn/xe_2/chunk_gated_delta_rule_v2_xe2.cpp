...
#include "chunk_gated_delta_rule_v2_xe2.hpp"
#include "chunk_gated_delta_rule_v2_xe2.h"

void chunk_gated_delta_rule_v2_xe2(
    sycl::queue& queue,
    ...
    const torch::Tensor& a,  // [num_v_heads, total_virtual_seqlen] (alpha/gate)
  ...
  gdn::v2::chunk_gated_delta_rule_v2_impl_xe2(
      queue,
      core_attn_out,
      q,
      k,
